...
//Code Here
let totalPopulation = populations.reduce((acc, population) => acc + population);
...
let bobsTotal = purchases.filter(purchaser => purchaser.owner === "Bob").reduce((acc, purchase) => acc + purchase.price, 0);
